...
function addQuestion(type, number) {
    if (type == "trueFalse"){
        test.concat({'questionType':'trueFalse', 'number':number});
    ...
    if (type == "multipleChoice"){
        test.concat({'questionType':'multipleChoice', 'number':number});
    ...
    if (type == "ranking"){
        test.concat({'questionType':'ranking', 'number':number});
